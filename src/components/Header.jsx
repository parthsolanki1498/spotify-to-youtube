...
{/* 
      <div className="relative inline-flex group pb-4">
        <div
          className="absolute transition-all duration-1000 opacity-70 -inset-px bg-gradient-to-r from-[#34A853] via-[#4285F4] to-[#FBBC05] rounded-xl blur-lg group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200 animate-tilt"
        ></div>
        <a
          href="#"
          title="Get quote now"
          className="relative inline-flex items-center justify-center px-10 py-5 text-lg font-bold text-white transition-all duration-200 bg-gray-900 font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
          role="button"
        >
          Google Login
        </a>
